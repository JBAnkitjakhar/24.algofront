              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center space-x-3 mb-4">
                  {solved ? (
                    ...
                    <Circle className="w-8 h-8 text-gray-400 dark:text-gray-500 flex-shrink-0" />
                  )}
                ...
                <div className="flex flex-wrap items-center gap-4 mb-4">
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${levelColors.bg} ${levelColors.text} ${levelColors.border}`}>
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3 mb-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-green-800 dark:text-green-300">
                        Solved on {dateUtils.formatDate(solvedAt)}
                      </span>
                    </div>
                  </div>
                )}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className={`font-medium ${levelColors.text}`}>
                        {QUESTION_LEVEL_LABELS[question.level]}
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600 dark:text-gray-400">Solutions</span>
                      <span className="font-medium text-gray-900 dark:text-white">
                        {solutions.length}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      ...
                      <span className={`font-medium ${solved ? 'text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400'}`}>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <button
                      onClick={() => router.push(`/categories/${question.categoryId}`)}
                    ...
                    >
                      <FolderOpen className="w-4 h-4" />
                      <span>More in {question.categoryName}</span>
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-medium">
                      {question.createdByName.charAt(0)}
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        {dateUtils.formatDate(question.createdAt)}
                      </p>
                    </div>
                  </div>
                </div>
