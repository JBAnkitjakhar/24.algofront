// src/components/questions/SolutionViewer.tsx - UPDATED VERSION
...
export function SolutionViewer({ solution, onBack }: SolutionViewerProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-900">
      {/* Header with Back Button and Action Links */}
          ...
          <div className="flex items-center space-x-3">
            ...
            {hasYouTube && (
              <a
                ...
                className="flex items-center space-x-2 px-3 py-2 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg transition-colors"
            ...
            {hasDrive && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 px-3 py-2 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/30 rounded-lg transition-colors"
              ...
              <div className="flex items-center space-x-2">
                {solution.visualizerFileIds!.map((fileId, index) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-medium">Visual {index + 1}</span>
                  </button>
                ))}
              </div>
            )}
            ...
            {hasCodeSnippet && viewMode !== 'code' && (
              <button
                ...
                className="flex items-center space-x-2 px-3 py-2 bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors"
      ...
      {/* Main Content Area - Full Height with Resizable Panels */}
      <div className="flex-1 flex min-h-0">
        ...
        >
          {viewMode === 'code' ? (
            ...
            <div className="h-full flex flex-col">
              <div className="bg-gray-50 dark:bg-gray-700 px-4 py-3 border-b border-gray-200 dark:border-gray-600 flex-shrink-0">
                <div className="flex items-center justify-between">
        ...
        {/* Right Panel - Solution Explanation Only */}
        <div 
